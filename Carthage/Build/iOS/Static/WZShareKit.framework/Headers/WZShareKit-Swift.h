...
#ifndef WZSHAREKIT_SWIFT_H
#define WZSHAREKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="WZShareKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class UIImage;

SWIFT_CLASS("_TtC10WZShareKit11AnyActivity")
...
SWIFT_CLASS("_TtC10WZShareKit10MonkeyKing")
...
@interface MonkeyKing (SWIFT_EXTENSION(WZShareKit)) <WKNavigationDelegate>
